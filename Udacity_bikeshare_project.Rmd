...
dc <- read.csv("/Users/junglee/Documents/School/Udacity_2020/R Module/washington.csv")
```
...
ggplot(aes(x=ch$Birth.Year), data = ch) +
  geom_histogram(binwidth = 1, color = 'grey', fill = 'light blue')+
...
ggplot(aes(x=ny$Birth.Year), data = ny) +
  geom_histogram(binwidth = 1, color = 'grey', fill = 'light green')+
  scale_x_continuous(limits = c(1950, 2005), breaks = seq(1950, 2015, 10))+
